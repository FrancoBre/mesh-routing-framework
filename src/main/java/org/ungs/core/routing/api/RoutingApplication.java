...
public abstract class RoutingApplication {
  ...
  /**
   * Called once per tick BEFORE any node processes packets.
   * Q-learning algorithms override this to snapshot their Q-tables,
   * ensuring all nodes see start-of-tick values when querying neighbors.
   */
