 ...
 *
 * <p>Instead of computing a cumulative average over ALL packets (which drowns out
 * recent performance changes), this metric computes the mean delivery time over
 * only the last {@code windowSize} delivered packets. This captures the "current"
 * performance of the algorithm and makes differences between algorithms visible
