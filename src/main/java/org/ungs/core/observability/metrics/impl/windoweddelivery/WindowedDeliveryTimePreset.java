...
public final class WindowedDeliveryTimePreset implements MetricPreset<List<Tuple<Double, Double>>> {
  ...
  public MetricBundle<List<Tuple<Double, Double>>> createBundle(
    ...
    return new MetricBundle(
        MetricType.WINDOWED_DELIVERY_TIME.name(), metric, perAlgoRenderer, comparisonRenderer);
  }
}
